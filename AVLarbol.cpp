...
void verArbol(ofstream &t,NodeAVL *&arbol, int n)
{
     if(arbol==NULL)
          return;
     verArbol(t,arbol->right, n+1);
...
int main()
{
    ...
    int dato;
    int remo;
    archivo.open("AVLarbol.txt",ios::out);
    archivo<<"digraph G{"<<endl;
    archivo<<"node [fontname=Arial,fontsize=\"15\",style=filled,fontcolor=\"white\"];";
    ...
    do{
        ...
        case 3:
            ...
            archivo<<"}";
            archivo.close();
            system("dot -Tpng AVLarbol.txt -o AVLarbol.png");
            system("start AVLarbol.png");
        default:
            break;
        }
